...
local lexer = require("gdshader_blink.syntax.lexer")

local token = require("gdshader_blink.syntax.token")

local cache = require("gdshader_blink.semantic.cache")

local treesitter = require("gdshader_blink.syntax.treesitter")
...
function M.get_lines(bufnr)
    return cache.memo(bufnr, "syntax_source_lines", function(raw_lines)
        ...
        local ranges = treesitter.get_comment_ranges(bufnr)

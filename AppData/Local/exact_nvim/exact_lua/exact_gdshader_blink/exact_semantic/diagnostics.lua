...
local cache = require("gdshader_blink.semantic.cache")
...
local ast = require("gdshader_blink.syntax.ast")

local AstKind = ast.Kind

local shader_types = require("gdshader_blink.data.shader_types")

------------------------------------------------------------
-- Lookup tables
------------------------------------------------------------

local shader_type_set = {}

for _, name in ipairs(shader_types) do
...
local all_processor_names = {}

for _, processor_list in pairs(processors) do
